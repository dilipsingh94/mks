    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Pressnotes Details</h4>
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col align-self-center">
                                                ...
                                                {{-- <i class="fa fa-pdf fa-4x bg-info text-white" style="padding: 10px; border-radius: 15px" aria-hidden="true"></i> --}}
                                            </div>
                                            <div class="col m-l-10 align-self-center">
                                                <h6 class="text-muted m-b-0">Total Pressnote <br> <small>(PDF Documents)</small> </h6>
                            ...
                            <div class="col-sm-8 text-right">
                                <a href="{{ route('pressnote.upload') }}" class="btn btn-info btn-sm rounded shadow mt-5 ml-5"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Upload New Document</a>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive m-t-20">
                            <table id="table" data-toggle="table" data-search="true" data-id-field="id" data-pagination="true" data-page-list="[10, 25, 50, 100, all]" >
                                <thead>
                                    <tr>
                                        <th>S.N</th>
                                        <th id="post">Document Name</th>
                                        <th id="description">Documet</th>
                                ...
                                <tbody>
                                    @foreach ($pressnotes as $post)
                                    <tr>
                                        <td class="text12">{{ $post->id }}</td>
                                        <td class="text12">{{ $post->documenttitle }}</td>
                                        <td class="text12">{{ $post->documentfile }}</td>
                                        <td class="text12">{{ $post->uploadername }}</td>
                                        ...
                                        <td>
                                            <div class="btn btn-sm btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item text12" href="{{ url('document/'.$post->id.'/edit') }}">Edit</a>
                                                    <a class="dropdown-item text12"  href="{{ url('document/'.$post->id.'/delete') }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
