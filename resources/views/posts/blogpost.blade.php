    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Blogpost Details</h4>
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col align-self-center">
                                                <i class="fa fa-edit fa-4x bg-info text-white" style="padding: 10px; border-radius: 15px" aria-hidden="true"></i>
                                            </div>
                                            <div class="col m-l-10 align-self-center">
                                                <h6 class="text-muted m-b-0">Total Post's</h6>
                            ...
                            <div class="col-sm-8 text-right">
                                <a href="{{ url('blogpost/create') }}" class="btn btn-info btn-sm rounded shadow mt-5 ml-5"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Create New Post</a>
                            </div>
                        </div>
                                        ...
                                        <td>
                                            <div class="btn btn-sm btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item text12" href="{{ url('blogpost/'.$post->id.'/edit') }}">Edit</a>
                                                    <a class="dropdown-item text12"  href="{{ url('blogpost/'.$post->id.'/delete') }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
