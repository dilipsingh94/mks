            ...
            <div class="col-lg-3 mb-4">
               ...
               <div >
                  ...
                  <div class="video-page text-success">
                     {{$video->uploadername}}  <a title="" data-placement="top" data-toggle="tooltip" href="#" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></a>
                  </div>
                  <div class="video-view"><i class="fas fa-calendar-alt"></i> {{$video->created_at->format('d-m-y')}}
                  </div>
               </div>
            </div>
            @endforeach
